<div class="container">
    ...
    <div class="row">
        <div class="col-lg-4 col-md-4">
            <div class="card-box-teky-1 card-box widget-box-two widget-two-custom">
                ...
                <div class="wigdet-two-content">
                    <h5 class="">
                        Go to Finance to deposit BTC, ETH, LTC, BCH into the wallet on bitgamecoins.com.
                    </h5>
        ...
        <div class="col-lg-4 col-md-4">
            <div class="card-box-teky-2 card-box widget-box-two widget-two-custom">
                ...
                <div class="teky-content-2 wigdet-two-content">
                    <h5 class="">
                        Check your balance on bitgamecoins.com. 
                    </h5>
        ...
        <div class="col-lg-4 col-md-4">
            <div style="height:118px;" class="card-box-teky-3 card-box widget-box-two widget-two-custom">
                <div class="icon-box-teky">
