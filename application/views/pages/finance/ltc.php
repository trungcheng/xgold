<div class="container" ng-controller="FinanceController" ng-init="loadDeposit()">
        ...
        <div class="col-xs-12">
            <div class="page-title-box" style="min-height:65px;">
                ...
                <div ng-cloak class="pull-right price_box">
                    <p>
                        <i class="mdi mdi-gift"></i> Total LTC: <span><b>{{ balance }}</b> LTC</span>
                    </p>
                    <!--<p class="text-right">
    ...
    <div class="row">
        ...
        <input type="hidden" id="coinName" value="Litecoin">
        <input type="hidden" id="typeCoin" value="ltc">
    </div>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="deposit" ng-if="type == 'deposit'">
                            <form id="depositForm" ng-submit="confirmDeposit()">
                                <input type="hidden" id="coinType" value="ltc">
                                <!-- <p style="font-weight:bold;color:#f00;font-size:14px;">- Step 1: Copy litecoin address or scan QR code to send ltc from other app to this address</p> -->
                                ...
                                <div class="input-group col-md-8 col-md-offset-2">
                                    ...
                                    <input readonly id="addr" type="text" class="form-control" name="toAddr" placeholder="Litecoin address" ng-model="addr">
                                </div>
                                <div style="display:block;text-align:center;margin-top:20px;margin-bottom:20px;">
                                    <qr type-number="5" size="250" text="addr"></qr>
                                </div>

                                <!-- <p style="margin-bottom:30px;font-weight:bold;color:#f00;font-size:14px;">- Step 2: After send ltc success, please get transaction id paste to trans id box in the below and fill amount, finally press CONFIRM button to submit your request to our system. (NOTE: Please input transaction ID correctly to confirm you have already transfer success)</p>
