            ...
            <div class="card-box">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="buy-BGMC-button m-t-20">
                            <a href="<?= base_url('ico') ?>" class="btn btn-custom waves-light waves-effect w-md">BUY BGMC NOW</a>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-top-10 alert alert-info alert-dismissible fade in" role="alert">
                            This is your BGMC referral link. You can use it to share the project with your friends and other interested parties. If any of them sign up with this link, they will be added to your referral program. 
                        </div>
                    </div>
                </div>                                    
            </div>
