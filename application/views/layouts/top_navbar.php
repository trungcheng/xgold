        ...
        <div class="container">
            ...
            <ul class="nav navbar-nav navbar-right">
                <?php
                    if (!empty($messages)) {
                        ?>
                        <li class="dropdown user-box" style="width:500px;height:40px;margin-top:15px;line-height:40px;color:#fff;font-weight:bold;background:#7b5050;border-radius:10px;">
